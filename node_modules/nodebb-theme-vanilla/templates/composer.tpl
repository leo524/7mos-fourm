<div class="composer">
	...
	<div class="composer-container">
		...
		<div class="tags-container">
			<input class="tags" type="text" class="form-control" placeholder="输入美味标签  " tabIndex="2"/>
		</div>
        ...
        <!-- map title -->
        <div class="form-group">
            <input  readonly id="flocation"  name="maptitle" class="form-control-confirmMap "  placeholder="请确认坐标"/>
