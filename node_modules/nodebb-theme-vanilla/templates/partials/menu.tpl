  ...
  <pre class="codeFirst" id="codeViewF">
    var statesdemof = {
	state1:{
    title: '查找美食坐标(双击小红点确认)',
	html:'&lt;div id="showmap" class="showmap"&gt;'+
        '&lt;div id="login-container"&gt;'+
             '&lt;input type="text" id="inputMap3" class="form-control-searchMap" placeholder="输入地址"/&gt;'+
            '&lt;button  class="btn btn-info searchMap" onclick="findPlace();"&gt;搜索&lt;/button&gt;'+
            '&lt;div class="form-row"&gt;&lt;div id="map_canvas"&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;',
	buttons: {  关闭: false },
		focus: 1,
...
$.prompt(statesdemof);
            ...
            <pre class="code" id="codeView">
    var statesdemo = {
	state0: {
    title: '美食坐标',
		html:'&lt;div  id="showmapView" class="showmapView"&gt;'+
    '&lt;div class="showmap-container"&gt;'+
    '&lt;div class="form-row"&gt;'+
      '&lt;div id="map_view"&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;',
		buttons: {  关闭: false },
		focus: 1,
		submit:function(e,v,m,f){
         $.prompt.close();
...
$.prompt(statesdemo);
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    document.getElementById("codeViewF").style.display="none";
