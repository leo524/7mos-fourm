							...
							<div class="col-md-12">
								...
								<div class="topic-text">
									...
									<h3 class="topic-title">
										<p id="topic_title_{posts.pid}" class="topic-title" itemprop="name"><i class="fa fa-thumb-tack hide"></i> <i class="fa fa-lock hide"></i> {title}
                                            <!--add weibo share -->

                                           &nbsp; &nbsp; <wb:share-button appkey="24bOi4" addition="simple" type="button" ralateUid="5235711210"></wb:share-button>
                                            <!--weibo share end --></p>

                                        <p id="cplace_{posts.pid}"  class="map-topic-title" itemprop="name"> <img  class="map-locationpng" src="/images/location.png"><i class="fa fa-thumb-tack hide"></i> <i class="fa fa-lock hide"></i>
                                            <a   href="#"  class="showviewMap" name="showmap">{cplace}</a>
                                        </p>
                                        <input type="hidden" id="cplace" value="{cplace}" />
